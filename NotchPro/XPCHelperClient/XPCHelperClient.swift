...
final class XPCHelperClient: NSObject {
    ...
    private let serviceName = "com.ryana79.notchpro.NotchProXPCHelper"
    
    private var remoteService: RemoteXPCService<NotchProXPCHelperProtocol>?
    ...
    @MainActor
    private func ensureRemoteService() -> RemoteXPCService<NotchProXPCHelperProtocol> {
        ...
        let service = RemoteXPCService<NotchProXPCHelperProtocol>(
            connection: conn,
            remoteInterface: NotchProXPCHelperProtocol.self
        )
    ...
    @MainActor
    private func getRemoteService() -> RemoteXPCService<NotchProXPCHelperProtocol>? {
        remoteService
    }
