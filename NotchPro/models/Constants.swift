...
enum LayoutPreset: String, CaseIterable, Identifiable, Defaults.Serializable {
    ...
    var description: String {
        switch self {
        case .balanced:
            return "Recommended — sleek music, weather & calendar, battery-friendly"
        case .minimal:
            return "Music controls only — lowest CPU and battery use"
        case .media:
            return "Full visualizer, album art tinting, and music live activity"
        case .productivity:
            return "Calendar, reminders, and HUD — media effects toned down"
        case .utility:
            return "Shelf, battery, and HUD — animations minimized"
        case .custom:
            return "Use your own settings"
        }
    }
}
...
extension Defaults.Keys {
    ...
    static let releaseName = Key<String>("releaseName", default: "NotchPro ⚡")
    ...
    static let lightingEffect = Key<Bool>("lightingEffect", default: false)
    ...
    static let performanceMode = Key<Bool>("performanceMode", default: false)
    static let layoutPreset = Key<LayoutPreset>("layoutPreset", default: .balanced)
    static let glassmorphismEnabled = Key<Bool>("glassmorphismEnabled", default: true)
    static let showWeatherGlance = Key<Bool>("showWeatherGlance", default: true)
    static let enableClipboardHistory = Key<Bool>("enableClipboardHistory", default: true)
    static let clipboardHistoryLimit = Key<Int>("clipboardHistoryLimit", default: 15)
    static let enableQuickScreenshot = Key<Bool>("enableQuickScreenshot", default: true)
    ...
    static let enablePortfolioInsights = Key<Bool>("enablePortfolioInsights", default: true)
    ...
    static let accentGlowEnabled = Key<Bool>("accentGlowEnabled", default: true)
    ...
    static let didApplyNotchProDefaultsV1 = Key<Bool>("didApplyNotchProDefaults_v1", default: false)
    static let didApplyNotchProUIV2 = Key<Bool>("didApplyNotchProUI_v2", default: false)
}
